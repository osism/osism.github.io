...
directory. This profile contains the name of the public network, which flavors
to use, etc.
...
|:---------------------|:---------|:----------------------------------------------|
| Instances            | 7        | 52 VCPUs + 208 GByte RAM (6 nodes, 1 manager) |
| Volumes              | 16       | 740 GByte volume storage                      |
| Floating IPs         | 1        |                                               |
| Keypairs             | 1        |                                               |
| Security groups      | 3        |                                               |
