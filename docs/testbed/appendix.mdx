...
This section describes how to configure and customize the OSISM Testbed.
...
* Rabbitmq
* Valkey (Redis with OSISM 10 and earlier)
...
You can inspect the [results of the daily zuul jobs](https://zuul.services.osism.tech/t/osism/builds?project=osism%2Ftestbed&skip=0).
