...
2. Run `./scripts/set-openstack-version.sh 2023.2` to set the OpenStack version to `2023.2`
...
| `/opt/configuration/scripts/deploy/001-helper-services.sh`                  |             |
| `/opt/configuration/scripts/deploy/100-ceph-services-basic.sh`              | alternative to ceph |
| `/opt/configuration/scripts/deploy/100-rook-services-basic.sh`              |             |
| `/opt/configuration/scripts/deploy/200-infrastructure-services-basic.sh`    |             |
...
| `/opt/configuration/scripts/upgrade/100-rook-services.sh`                 | alternative to ceph |
